// Considerando listas encadeadas de valores inteiros, implemente
// uma função que retorne o número de nós da lista que possuem o
// campo info com valores maiores do que x. Essa função deve
